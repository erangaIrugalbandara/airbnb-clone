        ...
        <header className='flex justify-between'>
            ...
            <div className='flex gap-2 border border-gray-300 rounded-full shadow-md shadow-gray-200 py-2 px-4'>
                ...
                <button className='bg-primary rounded-full p-1'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#ffff" className="w-4 h-4">
            ...
            <Link to={'/login'} className='flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4'>
                ...
                <div className='bg-gray-500 rounded-full border border-gray-500 overflow-hidden'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffff" className="size-6 relative top-1">
